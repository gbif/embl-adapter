...
public class SequencesWithIdentifiedByTask extends SequencesTask {
  ...
  public SequencesWithIdentifiedByTask(long numRecords, AtomicLong offset, EmblClient emblClient) {
    super(numRecords);
    this.offset = offset;
