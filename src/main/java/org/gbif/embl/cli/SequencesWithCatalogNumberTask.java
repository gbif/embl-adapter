...
public class SequencesWithCatalogNumberTask implements Runnable {
  ...
  public SequencesWithCatalogNumberTask(long numRecords, EmblClient emblClient) {
  ...
  @Override
  public void run() {
    LOG.info("SequencesWithCatalogNumberTask started!");
    while (offset.get() < numRecords) {
      ...
      LOG.info("SequencesWithCatalogNumberTask finished!");
    }
  }
}
